    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-12">
                ...
                <!-- arrows -->
                <div class="swiper-button-prev swiper-button-prev-news d-none d-xl-flex js-swiper-button-prev-news">
                    <img
                ...
                <div class="swiper-button-next swiper-button-next-news d-none d-xl-flex js-swiper-button-next-news">
                    <img
                    class="img-fluid"
                    ...
                    <div class="col-9 col-xl-3">
                        ...
                        <div class="row">
                            ...
                            <div class="col-12">
                                ...
                                href="<?php  $link_pattern . get_field('noticias_portal', 'option') ?>">
                                    Todas as Notícias
                                </a>
                            </div>
                        </div>
